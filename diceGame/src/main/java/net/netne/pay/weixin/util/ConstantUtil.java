package net.netne.pay.weixin.util;
...
public class ConstantUtil {
	...
	//初始化
	public static String APP_ID = "wx0efabc4ae60261b1";//微信开发平台应用id
	public static String APP_SECRET = "1873454ba48dafa9223f5cd38d8d49ec";//应用对应的凭证
	//应用对应的密钥
	public static String APP_KEY = "2A0vO7RXlbTS1NGPCQ4HQL57A6eHyvPVAyJ3NoAe2c3xCoC9IX4iiCY91b12Cfp2woi1jt1Megt4qiwtPjfQsfCSG2L58CqhdTiBORb0wqkG2e5gztOewvj5OkufnBV3";
	
	public static String PARTNER = "1221051001";//财付通商户号
	public static String PARTNER_KEY = "92b1a7afdcb331f9ddb20ba70713109d";//商户号对应的密钥
	...
	//接收财付通通知的URL
	public static String NOTIFY_URL = Constant.HOST_URL + "/weixin/callback.jsp";
}
